...
> _We now have access to the state within our App components (You can even test this using console.log or your React dev tools). Let's render the state as is on our screen._
